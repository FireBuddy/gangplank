      ...
      /*  private static void Jungle()
        ...
        private static void Draw(EventArgs args)
        {
            ...
            switch (SkinHackSelect)
            {
                ...
                case 0: color = Color.AntiqueWhite; break;
                case 1: color = Color.CornflowerBlue; break;
                case 2: color = Color.DarkOrange; break;
                case 3: color = Color.Red; break;
                case 4: color = Color.Yellow; break;
                case 5: color = Color.Maroon; break;
                case 6: color = Color.LimeGreen; break;
            }
            ...
            if (Menu["UseSkinHack"].Cast<CheckBox>().CurrentValue)
            {
                if (Menu.Get<KeyBind>("SkinLoad").CurrentValue)
                {
                    ...
                    {
                        default: color = Color.AntiqueWhite; break;
                        case 0: Hero.SetSkinId(0); break;
                        case 1: Hero.SetSkinId(1); break;
                        case 2: Hero.SetSkinId(2); break;
                        case 3: Hero.SetSkinId(3); break;
                        case 4: Hero.SetSkinId(4); break;
                        case 5: Hero.SetSkinId(5); break;
                        case 6: Hero.SetSkinId(6); break;
                    }
